...
Помимо витрины выше здесь лежат боты продажи VPN с управлением панелью Marzban,
распределённый агент парсинга на RabbitMQ, парсеры маркетплейсов и Avito с пулом
прокси и прогревом сессий, автоматизация регистраций с обходом антибот-защит,
мониторинг заказов на фрилансе с фильтрацией через GPT, веб-просмотрщик логов
и утилиты для разработки.

Всего 50+ репозиториев с октября 2024 по август 2026 - почти всё писалось
и эксплуатировалось в одиночку, от первой строки до продакшена.
